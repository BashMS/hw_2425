...
=== RUN   TestGetDomainStat_Time_And_Memory
    ...
    stats_optimization_test.go:46: time used: 1.938364s / 300ms
    ...
    assertion_compare.go:332:
                ...
                Error:          "1938364000" is not less than "300000000"

                Test:           TestGetDomainStat_Time_And_Memory

                Messages:       [the program is too slow]

--- FAIL: TestGetDomainStat_Time_And_Memory (1.99s)
...
=== RUN   TestGetDomainStat_Time_And_Memory
    ...
    stats_optimization_test.go:46: time used: 262.0026ms / 300ms

    stats_optimization_test.go:47: memory used: 11Mb / 30Mb

--- PASS: TestGetDomainStat_Time_And_Memory (4.41s)
